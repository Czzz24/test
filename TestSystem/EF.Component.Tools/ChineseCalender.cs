...
namespace EF.Component.Tools
{
    public class ChineseCalendar
    {
        ...
        /*******************  使用事例 ********************/
        //用公历（阳历）初始化
        //ChineseCalendar cc = new ChineseCalendar(Convert.ToDateTime("2010/4/5"));
        //ChineseCalendar cc = new ChineseCalendar(DateTime.Today);

        //用农历（阴历）初始化，润五月（润月用True否则用False)，公历2009年7月8日

        //ChineseCalendar cc = new ChineseCalendar(2009, 5, 16, true);

        //cc.ChineseDateString; //（农历二零零九年闰五月十六）

        //cc.ChineseTwentyFourDay;//二十四节气

        //cc.AnimalString;//属相（牛年）

        //cc.Constellation;//星座（巨蟹座）

        //cc.WeekDayStr;//星期（星期三）

        //cc.GanZhiYearString;//(己丑年)

        //cc.DateString;//(公元2009年7月8日)

        //cc.DateHoliday;//按照公历计算的节日

        //cc.ChineseCalendarHoliday;//中国农历节日

        //cc.ChineseMonth;//农历月份

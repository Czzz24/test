var tmyChart1 = echarts.init(document.getElementById('aTrend'));
...
tmyChart1.setOption(option);

/*重置echarts*/
function resettmyChart1(data) {
    var options = tmyChart1.getOption();
    if (tmyChart1) {
        tmyChart1.dispose();
    }
    tmyChart1 = echarts.init(document.getElementById('aTrend'));
    if (typeof options === 'object') {
        ...
        tmyChart1.setOption(options, true);
    }
}
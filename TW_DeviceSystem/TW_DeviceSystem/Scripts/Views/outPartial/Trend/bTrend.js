var tmyChart2 = echarts.init(document.getElementById('bTrend'));
...
tmyChart2.setOption(option);

/*重置echarts*/
function resettmyChart2(data) {
    var options = tmyChart2.getOption();
    if (tmyChart2) {
        tmyChart2.dispose();
    }
    tmyChart2 = echarts.init(document.getElementById('bTrend'));
    if (typeof options === 'object') {
        ...
        tmyChart2.setOption(options, true);
    }
}
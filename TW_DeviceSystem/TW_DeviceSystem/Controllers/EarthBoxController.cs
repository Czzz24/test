...
{
    [AccountAuthorize]
    public class EarthBoxController : Controller
    {
        ...
        private readonly static t_AlarmPictureBLL picturebll = new t_AlarmPictureBLL();
        ...
        public ActionResult Temp(string TerminalId, int ElectricId, int LineId)
        {
            ViewBag.TerminalId = TerminalId;
            ViewBag.ElectricId = ElectricId;
            ViewBag.LineId = LineId;
        ...
        /// 获取接地箱最新数据
        /// </summary>
        /// <param name="TerminalId">设备唯一标识</param>
        ...
        public virtual JsonResult GetChartData(string TerminalId, int ElectricId, int LineId,DateTime? startTime,DateTime? endTime)
        {
            ...
            List<EarthBoxLine> list = bll.GetEarthBoxChartData(conFstr, TerminalId, startTime, endTime);
            ...
            series[8].data.AddRange(BatteryVolt);
            series[9].data.AddRange(Volt1);
            series[10].data.AddRange(Volt2);
        ...
        /// <param name="endTime"></param>
        /// <returns></returns>
        public virtual JsonResult GetChartTempData(string TerminalId, int ElectricId, int LineId, DateTime? startTime, DateTime? endTime)
        {
            //图例颜色
            List<string> color = new List<string>();
            color.Add("#F2DF7D");
        ...
        /// <returns></returns>
        public virtual JsonResult GetEarthBoxAlamPicture(long alarmId, int ElectricId, int LineId)
        {
            FromConnection fromCon = new FromConnection();
            string conFstr = fromCon.GetConStr(conStr, ElectricId, LineId);
            List<t_AlarmPicture> list = picturebll.GetPicture(conFstr, alarmId);

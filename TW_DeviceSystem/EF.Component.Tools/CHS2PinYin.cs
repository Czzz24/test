...
namespace EF.Component.Tools
{
    ...
    /// 将汉字转化为拼音的类
    /// </summary>
    public static class CHS2PinYin
    {
        /// <summary>
        /// 包含字符 ASC 码的整形数组。
        /// </summary>
        ...
        /// <returns></returns>
        public static string TransCapital(string chs)
        {
        ...
        /// <returns></returns>
        public static DataTable TransCapital(DataTable dt, string textField)
        {
        ...
        /// <param name="separator">连接拼音之间的分隔符。</param>
        /// <returns></returns>
        public static DataTable TransCapital(DataTable dt, string textField, string separator)
        {
